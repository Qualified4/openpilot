...
class CarInterfaceBase(ABC):
  ...
  def apply(self, c: structs.CarControl, now_nanos: int | None = None, model_v2=None, radar_state = None, live_tracks=None) -> tuple[structs.CarControl.Actuators, list[CanData]]:

  ...
  def _draw_radar_info(self):
    ...
    for item in self._radar_info_items:
      ...
      if item.is_star:
        ...
        draw_text_ui_style(item.text, item.x, item.y, font_size, item.color, font=self._font_display, border_width=1.0, shadow_offset=0, align="center", y_offset=0.0)
        continue
      ...
      draw_text_ui_style(item.text, tx, ty, font_size, rl.WHITE, font=self._font_display, border_width=1.0, shadow_offset=0, align="left_top", y_offset=0.0)
